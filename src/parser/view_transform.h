...
extern bool mq_dblink_append_corr_pred_sql (PARSER_CONTEXT * parser, PT_DBLINK_INFO * di, PT_NODE * remote_col);
extern void mq_dblink_clear_corr_keys (PT_DBLINK_INFO * dinfo);
