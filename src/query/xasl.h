...
struct dblink_spec_node
{
  ...
  int join_key_count;		/* join key count for dblink spec (remote.col = local.col push) */
  REGU_VARIABLE_LIST join_key_regu_list;	/* regu list for join keys (outer val_list refs) */
